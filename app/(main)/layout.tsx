...
export default async function MainLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <>
            <Header />
            <div className="app-shell h-[calc(100dvh-81px)] overflow-hidden bg-[#07130f] text-white">
                <div className="flex h-full overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(27,185,119,0.20),_transparent_34%),linear-gradient(135deg,_#07130f_0%,_#0f1d1b_52%,_#111827_100%)]">
                    ...
                    <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
                        <header className="shrink-0 border-b border-white/10 bg-[#07130f]/90 px-4 py-3 backdrop-blur-xl md:px-6 md:py-4">
